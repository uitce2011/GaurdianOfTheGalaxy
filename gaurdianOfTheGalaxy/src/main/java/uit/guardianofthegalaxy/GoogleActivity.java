...
public class GoogleActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ggplus);
	...
	private void shareOnGplus() {
		...
		if (mGoogleApiClient.isConnected()) {
			 ...
			 .setText( "Thanks for playing game Guardian Of The Galaxy") 
			 .setType("text/plain")
			 .setContentUrl( Uri.parse("https://play.google.com/store"))
			 .getIntent(); startActivityForResult(shareIntent,0);
			 
		} else {
			Toast.makeText(this, "Please Sign-in with google Account",
